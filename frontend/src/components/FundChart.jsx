...
const FundChart = ({ funds, sortBy, showNewOnly, getSortLabel, AMC_COLORS }) => {
    ...
    return (
        <div className="lg:col-span-2 bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 mb-6 font-sans">
            ...
            <div className="h-48 sm:h-64 lg:h-80 w-full">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 16, left: 8, bottom: 5 }}>
                        ...
                        <XAxis type="number" unit="%" tick={{ fill: '#64748b', fontSize: 10, fontFamily: 'Kanit' }} />
                        <YAxis dataKey="name" type="category" width={90} tick={{ fill: '#475569', fontSize: 10, fontWeight: 500, fontFamily: 'Kanit' }} />
                        <Tooltip
                            cursor={{ fill: '#f1f5f9' }}
